...
urlpatterns = [path("home/", views.IndexView.as_view(), name="home"),
               ...
               path("message/<int:pk>/detail/", cache_page(60)(views.MessageDetailView.as_view()), name="message_detail"),
               ...
               path("mailing/<int:pk>/detail/", cache_page(60)(views.MailingDetailView.as_view()), name="mailing_detail"),
